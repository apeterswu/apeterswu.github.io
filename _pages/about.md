...
My researches focus on Natural Language Processing (NLP), Deep Learning (DL). Specifically, sequence-to-sequence learning tasks such as Neural Machine Translation (NMT) and Summarization. I am also interested in meta-learning, Reinforcement Learning (RL).
